      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-text-secondary font-mono">
            &copy; {currentYear} Daniel Gelchu. All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="Daniel Gelchu's GitHub Profile (opens in new tab)"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="p-2 text-text-secondary hover:text-text-primary hover:bg-surface-hover rounded-lg transition-colors focus-visible:outline-2 focus-visible:outline-accent"
              aria-label="Daniel Gelchu's LinkedIn Profile (opens in new tab)"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
